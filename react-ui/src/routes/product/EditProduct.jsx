...
const EditProduct = ({ product }) => {
  ...
  const handleEditBtnSubmitToBackend = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8080/product/${product.product_id}`, {
        method: "PUT",
  ...
  return (
    <>
      <div class="container">
        ...
        <div class="modal fade" id={`id${product.product_id}`} onClick={handleResetData}>
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">Edit Product Name</h4>
                <button type="button" class="close" data-dismiss="modal" onClick={handleResetData}>
                  &times;
                </button>
              </div>
